...
const m = [
  { pId: "p1", cat: "医学原虫", zh: "溶组织内阿米巴", sc: "Entamoeba histolytica", desc: "引起阿米巴痢疾", stageIds: [1, 2] },
  { pId: "p2", cat: "医学原虫", zh: "阴道毛滴虫", sc: "Trichomonas vaginalis", desc: "引致滴虫性阴道炎", stageIds: [3] },
  { pId: "p3", cat: "医学原虫", zh: "蓝氏贾第鞭毛虫", sc: "Giardia lamblia", desc: "引起贾第虫病，具有标志性的对称人脸结构", stageIds: [4, 5] },
  { pId: "p4", cat: "医学原虫", zh: "杜氏利什曼原虫", sc: "Leishmania donovani", desc: "引起黑热病，在巨噬细胞内繁殖", stageIds: [6, 7] },
  { pId: "p5", cat: "医学原虫", zh: "间日疟原虫", sc: "Plasmodium vivax", desc: "引起间日疟，感染年轻红细胞", stageIds: [8, 9, 10] },
  { pId: "p6", cat: "医学原虫", zh: "恶性疟原虫", sc: "Plasmodium falciparum", desc: "引起恶性疟，有新月形配子体", stageIds: [11, 12] },
  
  { pId: "p7", cat: "医学吸虫", zh: "华支睾吸虫 (肝吸虫)", sc: "Clonorchis sinensis", desc: "寄生于胆管，形如葵花籽", stageIds: [13, 14] },
  { pId: "p8", cat: "医学吸虫", zh: "卫氏并殖吸虫 (肺吸虫)", sc: "Paragonimus westermani", desc: "寄生于肺部，形如咖啡豆", stageIds: [15, 16, 17] },
  { pId: "p9", cat: "医学吸虫", zh: "日本血吸虫", sc: "Schistosoma japonicum", desc: "雌雄异体，寄生于肠系膜静脉", stageIds: [18, 19, 20] },
  { pId: "p10", cat: "医学吸虫", zh: "布氏姜片吸虫 (姜片虫)", sc: "Fasciolopsis buski", desc: "最大的肠道寄生吸虫", stageIds: [21, 22] },

  { pId: "p11", cat: "医学绦虫", zh: "带绦虫卵", sc: "Taenia egg", desc: "猪带和牛带绦虫卵形态一致", stageIds: [23] },
  { pId: "p12", cat: "医学绦虫", zh: "链状带绦虫 (猪带绦虫)", sc: "Taenia solium", desc: "可引起绦虫病和囊虫病", stageIds: [24, 25, 26, 27] },
  { pId: "p13", cat: "医学绦虫", zh: "肥胖带绦虫 (牛带绦虫)", sc: "Taenia saginata", desc: "只引起绦虫病，较长", stageIds: [28, 29, 30, 31] },

  { pId: "p14", cat: "医学线虫", zh: "似蚓蛔线虫 (蛔虫)", sc: "Ascaris lumbricoides", desc: "最大的肠道线虫，寄生于小肠", stageIds: [32, 33, 34, 35, 36] },
  { pId: "p15", cat: "医学线虫", zh: "钩虫", sc: "Hookworm", desc: "幼虫钻皮肤感染，吸血引起贫血", stageIds: [37] },
  { pId: "p16", cat: "医学线虫", zh: "十二指肠钩口线虫", sc: "Ancylostoma duodenale", desc: "有两对尖锐钩齿", stageIds: [38, 40] },
  { pId: "p17", cat: "医学线虫", zh: "美洲板口线虫", sc: "Necator americanus", desc: "有一对半月形板齿", stageIds: [39, 41] },
  { pId: "p18", cat: "医学线虫", zh: "蠕形住肠线虫 (蛲虫)", sc: "Enterobius vermicularis", desc: "寄生于盲肠，夜间肛周排卵", stageIds: [42, 43] },
  { pId: "p19", cat: "医学线虫", zh: "毛首鞭形线虫 (鞭虫)", sc: "Trichuris trichiura", desc: "形如马鞭，寄生于盲肠", stageIds: [44, 45, 46] },
  { pId: "p20", cat: "医学线虫", zh: "班氏吴策线虫", sc: "Wuchereria bancrofti", desc: "引起淋巴丝虫病", stageIds: [47] },
  { pId: "p21", cat: "医学线虫", zh: "马来布鲁线虫", sc: "Brugia malayi", desc: "引起淋巴丝虫病", stageIds: [48] }
];
...
const imageIndex = {};
try { imageIndex['p'] = JSON.parse(fs.readFileSync('new_images.json', 'utf-8')); } catch(e) {}
const realImageIndex = imageIndex['p'] || {};
...
async function doWork() {
  ...
  for (const group of m) {
      const p = {
          id: group.pId,
          category: group.cat,
          chineseName: group.zh,
          scientificName: group.sc,
          description: group.desc,
          stages: []
      };
      for (const sid of group.stageIds) {
          const sm = mapping.find(x => x.id === sid);
          if(!sm) continue;
          let urls = realImageIndex[sm.key] || [];
          if(urls.length < 2 && fallbackUrls[sm.key]) {
              urls = Array.from(new Set([...urls, ...fallbackUrls[sm.key]]));
          }
          if (urls.length < 2) {
            let u = await fetchWikiImages(sm.key);
            urls = Array.from(new Set([...urls, ...u]));
          }
          
          if (urls.length === 0) urls = ["https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/600px-No_image_available.svg.png"];
  ...
  fs.writeFileSync('src/data.ts', `import { Parasite } from './types';\n\nexport const parasiteData: Parasite[] = ${JSON.stringify(parasites, null, 2)};\n`);
}
